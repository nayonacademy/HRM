...
class EmployeePersonalForm(forms.ModelForm):
    class Meta:
        ...
        widgets={
            ...
            'blood_group':forms.TextInput(attrs={'class':'form-control input-circle','placeholder':'Blood Group'}),
...
class EmployeeContactForm(forms.ModelForm):
    class Meta:
        ...
        widgets={
            ...
            'contact_email':forms.EmailInput(attrs={'class':'form-control','placeholder':'eg.: email@email.com'}),
            'present_address':forms.Textarea(attrs={'class':'form-control','rows':'2','cols':'3','placeholder':'Present Address'}),
            'permanent_address':forms.Textarea(attrs={'class':'form-control','rows':'2','cols':'3','placeholder':'Parmanent Address'})
...
class EmployeeBankForm(forms.ModelForm):
    ...
    widgets={
        ...
        'bank_name':forms.TextInput(attrs={'class':'form-control','placeholder':'Bank No'}),
